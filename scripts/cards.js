...
export class Card {
  ...
  generateCard() {
      ...
      this._cardImage.style.backgroundImage = `url(${this._data.link})`;  //openImagePreview Function - replaced by those2
      this._cardElement.querySelector('popup__subtitle').textContent = this._data.name;
